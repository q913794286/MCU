...
#line 12 "app\main.c" /0
 ...
 ADC_InitStructure.ADC_Px        = 0x01 | 0x02 | 0x04;	 
 ADC_InitStructure.ADC_Speed     = (1<<5);			 
 ADC_InitStructure.ADC_Power     = 1;			 
 ADC_InitStructure.ADC_AdjResult = 0;		 
 ...
 COMx_InitStructure.UART_BRT_Use   = 1;			 
 ...
 COMx_InitStructure.UART_Polity    = 0;			 
 COMx_InitStructure.UART_P_SW      = 0;	 
 USART_Configuration(2, &COMx_InitStructure);		 
 ...
 COMx_InitStructure.UART_Mode      = (1<<6);		 
 COMx_InitStructure.UART_BRT_Use   = 1;			 
 COMx_InitStructure.UART_BaudRate  = buad;			 
 COMx_InitStructure.UART_RxEnable  = 1;				 
 COMx_InitStructure.BaudRateDouble = 0;			 
 COMx_InitStructure.UART_Interrupt = 1;				 
 COMx_InitStructure.UART_Polity    = 0;			 
