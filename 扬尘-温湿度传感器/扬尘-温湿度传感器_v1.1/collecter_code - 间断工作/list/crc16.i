...
#line 1 "app\service\CRC16\crc16.c" /0
...
#line 2 "app\service\CRC16\crc16.c" /0
...
#line 3 "app\service\CRC16\crc16.c" /0
#line 3 "app\service\CRC16\crc16.c" /0
...
#line 5 "app\service\CRC16\crc16.c" /0
 ...
 while (usDataLen1--)  
 {		
 uIndex = uchCRCHi ^ *puchMsg1++ ;  
 uchCRCHi = uchCRCLo ^ auchCRCHi[uIndex] ;
 uchCRCLo = auchCRCLo[uIndex] ;
 }
 while (usDataLen2--)  
 {		
 uIndex = uchCRCHi ^ *puchMsg2++ ;  
 uchCRCHi = uchCRCLo ^ auchCRCHi[uIndex] ;
 uchCRCLo = auchCRCLo[uIndex] ;
 }
 return (uchCRCHi << 8 | uchCRCLo) ;
