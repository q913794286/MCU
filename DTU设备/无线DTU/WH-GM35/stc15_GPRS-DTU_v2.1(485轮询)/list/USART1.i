...
#line 16 "stclib\USART1.C" /0
 ...
 u8 xdata TX1_Buffer[64];	 
 u8 xdata RX1_Buffer[128];	 
 
 u8 xdata TX2_Buffer[64];	 
 u8 xdata RX2_Buffer[128];	 
 ...
 for(i=0; i<128; i++)	RX1_Buffer[i] = 0;
 ...
 COM2.RX_TimeOut = 0;
 COM2.B_RX_OK    = 0;
 for(i=0; i<64; i++)	TX2_Buffer[i] = 0;
 for(i=0; i<128; i++)	RX2_Buffer[i] = 0;
 ...
 void UART1_init (void) interrupt 4 using 2
 {
 char buf;
 if(RI)
 {
 ...
 {		 
 buf = SBUF;
 uart1_set_TimeOut(20); 	 
 if(COM1.RX_Cnt >= 128)	COM1.RX_Cnt = 0;	
 COM1.RX_TimeOut = 5;	
 if(config_mode==1)
 {
 ...
 switch(buf)
 {
 case 0x80: cmd_flg = 1; COM1.RX_Cnt = 0; break;
 case 0x81: if(cmd_flg == 1 && COM1.RX_Cnt == 1){printf("MU");uart1_cmd = 1 ;cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 
 case 0x82: cmd_flg = 2; COM1.RX_Cnt = 0; break;
 case 0x83: if(cmd_flg == 2 && COM1.RX_Cnt == 1){uart1_cmd = 2; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 
 case 0x84: cmd_flg = 3; COM1.RX_Cnt = 0; break;
 case 0x85: if(cmd_flg == 3 && COM1.RX_Cnt == 1){uart1_cmd = 3; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 0x86: cmd_flg = 4; COM1.RX_Cnt = 0; break;
 case 0x87: if(cmd_flg == 4 && COM1.RX_Cnt == 1){uart1_cmd = 4; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 0x88: cmd_flg = 5; COM1.RX_Cnt = 0; break;
 case 0x89: if(cmd_flg == 5 && COM1.RX_Cnt == 1){uart1_cmd = 5; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 default:  break;
 }				
 }
 else{
 ...
 if(COM2.B_RX_OK == 0)	  
 {
 uart2_set_TimeOut(20);  
 if(COM2.RX_Cnt >= 128)	COM2.RX_Cnt = 0;  
