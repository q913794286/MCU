...
#line 16 "stclib\USART1.C" /0
 ...
 u8 xdata TX1_Buffer[128];	 
 u8 xdata RX1_Buffer[128];	 
 
 u8 xdata TX2_Buffer[128];	 
 ...
 COM1.B_RX_OK    = 0;
 uart1_cmd		= 0;
 for(i=0; i<128; i++)	TX1_Buffer[i] = 0;
 ...
 COM2.RX_TimeOut = 0;
 COM2.B_RX_OK    = 0;
 for(i=0; i<128; i++)	TX2_Buffer[i] = 0;
 ...
 case '?': if(cmd_flg == 1 && COM1.RX_Cnt == 1){uart1_cmd = 1; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 
 case 'C': cmd_flg = 2; COM1.RX_Cnt = 0; break;
 case '#': if(cmd_flg == 2 && COM1.RX_Cnt == 1){uart1_cmd = 1; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 
 case 'S': cmd_flg = 3; COM1.RX_Cnt = 0; break;
 case '+': if(cmd_flg == 3 && COM1.RX_Cnt == 1){uart1_cmd = 3; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 'G': cmd_flg = 4; COM1.RX_Cnt = 0; break;
 case '*': if(cmd_flg == 4 && COM1.RX_Cnt == 1){uart1_cmd = 4; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 'Q': cmd_flg = 5; COM1.RX_Cnt = 0; break;
 case '!': if(cmd_flg == 5 && COM1.RX_Cnt == 1){uart1_cmd = 5; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 default:  break;
 }				
 }
