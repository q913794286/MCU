...
#line 16 "stclib\USART1.C" /0
 ...
 case 'C': cmd_flg = 1; COM1.RX_Cnt = 0; break;
 case '#': if(cmd_flg == 1 && COM1.RX_Cnt == 1){uart1_cmd = 1; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 
 case 'S': cmd_flg = 2; COM1.RX_Cnt = 0; break;
 case '+': if(cmd_flg == 2 && COM1.RX_Cnt == 1){uart1_cmd = 3; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 'G': cmd_flg = 3; COM1.RX_Cnt = 0; break;
 case '*': if(cmd_flg == 3 && COM1.RX_Cnt == 1){uart1_cmd = 4; cmd_flg = 0; COM1.RX_Cnt = 0;} break;	  
 
 case 'Q': cmd_flg = 4; COM1.RX_Cnt = 0; break;
 case '!': if(cmd_flg == 4 && COM1.RX_Cnt == 1){uart1_cmd = 5; cmd_flg = 0; COM1.RX_Cnt = 0;} break;  
 default:  break;
 }				
 }
